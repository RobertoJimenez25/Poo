...
public class Ventana extends JFrame {
    ...
    public Ventana(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(156, 243, 140, 255));
        lblID = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(191, 139, 232));
        info = new ArrayList<>();
        info.add(new VideoJuego(1,"League of Legeds",
                "MOBA",4.5,"Windows,Mac",
                "Riot Games"));
